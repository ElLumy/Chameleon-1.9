...
// Función para inyectar script externo con mejor manejo de errores
function injectExternalScript(url, attributes = {}) {
    return new Promise((resolve, reject) => {
        ...
        script.onload = () => {
            console.log(`[Chameleon Injector] Script loaded: ${url}`);
            resolve(script);
        };
...
async function injectChameleonLoader() {
    ...
    try {
        ...
        await injectExternalScript(bootstrapUrl, {
        ...
        await injectExternalScript(loaderUrl);
